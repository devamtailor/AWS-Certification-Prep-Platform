...
## 🚀 Interactive Exam Prep Platform

We have built a fully featured, browser-based **[Interactive Exam Prep Platform](./platform.html)** using the resources in this repository. 

### Features:
- **Interactive Exams**: Practice all 23 exams in **Study Mode** (instant answers and explanations) or **Exam Mode** (simulated timed environment).
- **Personalized Dashboard**: Track notes completed, average quiz scores, and review detailed lists of past exam history.
- **Optimized Notes Reader**: Clean readability layout with responsive typography, search filter, and automated table-of-contents navigation.
- **Syllabus & Mind Map**: Explore official domain breakdowns and interactive nodes.

👉 **[Launch the Exam Prep Platform Now](./platform.html)**
